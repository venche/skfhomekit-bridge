...
public:
    bool _value;
    //adding silvan implementaion
     string jsonobject;

    //void (*valueChangeFunctionCall)(bool oldValue, bool newValue) = NULL;
    void (*valueChangeFunctionCall)(bool oldValue, bool newValue,string skf_api_object) = NULL;
    ...
    virtual void setValue(string str) {
        ...
        if (valueChangeFunctionCall)
        	valueChangeFunctionCall(_value, newValue,jsonobject);
            printf("setval+3\n");
...
public:
    ...
    const unit _unit;
    string jsonobject;  //adding silvan implementaion
    //void (*valueChangeFunctionCall)(float oldValue, float newValue) = NULL;
    void (*valueChangeFunctionCall)(float oldValue, float newValue,string skf_api_object) = NULL;
    ...
    virtual void setValue(string str) {
        ...
        if (temp == temp) {
            if (valueChangeFunctionCall)
            	//valueChangeFunctionCall(_value, temp); //modify to take more parameters
                valueChangeFunctionCall(_value, temp,jsonobject); //modify to take more parameters
            _value = temp;
        }
    }
    virtual string describe();
...
public:
    ...
    //void (*valueChangeFunctionCall)(bool oldValue, bool newValue) = NULL;
    void (*valueChangeFunctionCall)(int oldValue, int newValue,string skf_api_object) = NULL;
    ...
    virtual void setValue(string str) {
        ...
        if (temp == temp) {
            if (valueChangeFunctionCall)
                ...
                valueChangeFunctionCall(_value, temp,jsonobject);
            _value = temp;
        }
    }
    virtual string describe();
...
typedef void (*identifyFunction)(bool oldValue, bool newValue,string skf_api_object);
